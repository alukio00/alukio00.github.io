...
const zoomIn = (index, indexUrl) => {
    ...
    zoomDiv.innerHTML = `
        <img src="${obrazy[index].url[indexUrl]}" alt="Powiększony obraz obiektu" class="my-auto rounded-2xl shadow-xl object-cover w-auto h-screen max-xl:h-min max-xl:w-11/12">
    `;
}
